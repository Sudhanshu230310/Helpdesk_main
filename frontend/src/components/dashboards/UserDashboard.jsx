import { HiOutlineTicket, HiOutlineClock, HiOutlineCheckCircle, HiOutlineExclamation } from 'react-icons/hi';
import { Link } from 'react-router-dom';
import TicketCard from '../TicketCard';

const UserDashboard = ({ stats, recentTickets }) => {
    const statCards = [
                    ...
                    <div className="space-y-3">
                        {recentTickets.length > 0 ? (
                            ...
                            <div className="glass-card p-8 text-center">
                                ...
                                <p className="text-gray-500">You haven't raised any tickets yet</p>
