import { HiOutlineTicket, HiOutlineClock, HiOutlineCheckCircle, HiOutlineExclamation, HiOutlineStar, HiOutlineTrendingUp } from 'react-icons/hi';
import { Link } from 'react-router-dom';
import TicketCard from '../TicketCard';

const TechnicianDashboard = ({ stats, recentTickets }) => {
    const statCards = [
        ...
        //  { label: 'With User', value: stats?.with_user_tickets || 0, icon: HiOutlineTicket, color: 'purple' },
        { label: 'Resolved', value: stats?.resolved_tickets || 0, icon: HiOutlineCheckCircle, color: 'emerald' },
            ...
            <div className="grid grid-cols-1 gap-6">
                <div>
                    <div className="flex items-center justify-between mb-4">
                        <h2 className="text-lg font-semibold text-gray-900">Your Assigned Tickets ({recentTickets.length})</h2>
